...
The soft 404 detector is integrated into the [Website Scanner](/tools/website-scanner).
...
The soft 404 detector is also integrated into the [URL Fuzzer](/tools/url-fuzzer).

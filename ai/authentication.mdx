...
The AI-enhanced authentication feature improves the reliability of automatic login form detection in the [Website Scanner](/tools/website-scanner). AI helps complete logins on complex or dynamic pages where traditional detection methods struggle.
...
AI-enhanced authentication improves login reliability on complex pages where selector-based detection fails.

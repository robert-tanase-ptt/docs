...
<Steps>
  ...
  <Step title="Get your API key">
    The Docker command takes your Pentest-Tools API key as the `--key` argument. Store it as a secret in your CI/CD system — don't paste it directly into pipeline files.
  </Step>

...
Some tools don't generate structured findings. They return tool-specific output instead: discovered hosts, raw console output, or takeover reports. See [Tools](/core/tools) for details on what each one returns.
...
- [Scan types](/core/scans/scan-types-and-depth)

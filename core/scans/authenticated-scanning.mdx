...
The [SQLi Exploiter](/tools/sqli-exploiter) lets you provide a cookie header in the **Advanced** options to test authenticated pages for SQL injection vulnerabilities.
...
[Sniper](/tools/sniper) supports authenticated scans via four protocols. Use them to extract system artifacts through an authenticated session.

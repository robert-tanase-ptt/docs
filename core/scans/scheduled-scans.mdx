...
- **Pentest Robots**: Schedule [Pentest Robots](/capabilities/pentest-robots) to run automated, multi-tool assessments on a recurring basis
...
When scheduling a scan, you can optionally send the results to [Vanta](/capabilities/integrations/vanta) for automated compliance monitoring and evidence collection.

**To enable Vanta integration:**
1. First, [configure the Vanta integration](/capabilities/integrations/vanta) in your account settings
...
Scheduled scans work with the [notifications system](/capabilities/notifications). Configure alerts to stay informed about your automated scans:
...
- [Notifications overview](/capabilities/notifications)

...
The Password Auditor is a **vulnerability scanner**: it actively tests for authentication weaknesses. It does not add data to your [Attack Surface](/capabilities/attack-surface). Discovered weak credentials are reported as [findings](/core/findings/findings).
...
The Top 100 list covers the most common ports for services the Password Auditor supports. See [Port lists](/core/scans/portlists) for the exact ports.

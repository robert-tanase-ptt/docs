...
<Note>
By default, the scanner follows redirects within the same domain (e.g., `example.com` to `www.example.com`). Configure this with [Follow redirects](/using/scans/follow-redirects). To scan a specific directory, include the path in the URL (e.g., `https://example.com/app/`).
</Note>

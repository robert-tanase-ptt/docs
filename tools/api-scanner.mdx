...
The API Scanner is a **vulnerability scanner**: it actively tests APIs for security weaknesses. It does not add data to your [Attack Surface](/capabilities/attack-surface). Identified vulnerabilities are reported as [findings](/core/findings/findings).
...
For more details, see [Authenticated scanning > API Scanner](/core/scans/authenticated-scanning#api-scanner).

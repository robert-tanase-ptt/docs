...
The WordPress Scanner is a **vulnerability scanner**: it actively tests WordPress sites for security weaknesses. It does not add data to your [Attack Surface](/capabilities/attack-surface). Identified vulnerabilities are reported as [findings](/core/findings/findings).
...
For detailed authentication configuration, see [Authenticated scanning](/core/scans/authenticated-scanning#wordpress-scanner).

...
| **Deep** | Aggressive detection with full enumeration | Comprehensive audit |
...
The WordPress Scanner uses WPScan technology and follows a systematic approach:
...
- **High-value target**: WordPress powers 40%+ of websites, making it a prime target for attackers
- **Plugin vulnerabilities**: Third-party plugins are the most common attack vector
- **Outdated installations**: Many sites run outdated WordPress, plugins, or themes
- **Default configurations**: XML-RPC, user enumeration, and other defaults can be exploited

...
Website Recon identifies server-side and client-side technologies on a web application. It generates [findings](/using/findings/findings) for each detected technology and adds results to your [Attack Surface](/using/attack-surface/attack-surface-overview).

...
| **Deep** | Scan ~2,012 TCP ports | Full infrastructure audit |
...
|-----------|:-----:|:----:|:------:|
| **TCP ports** | 443 | ~2,012 | User-defined |
...
<Warning>
The Deep scan tests ~2,012 ports and may take significant time. Use Light mode for quick HTTPS checks or Custom mode to specify exact ports.
</Warning>
...
|--------|-----------|-------------|
| **Top 10 ports** | ~7 | Fastest scan |
| **Top 100 ports** | ~85 | Quick discovery |
...
- **Data protection**: Weak SSL/TLS allows attackers to decrypt sensitive communications
- **Compliance**: PCI DSS, HIPAA, and other regulations require strong encryption
- **Trust**: Modern browsers warn users about insecure configurations
- **Attack surface**: Deprecated protocols and weak ciphers are actively exploited

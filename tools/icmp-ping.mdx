...
- **Quick reachability check**: Verify a host is online before running other scans
- **DNS resolution**: Find the IP address of a hostname
- **Network troubleshooting**: Diagnose connectivity issues
- **Latency measurement**: Measure network round-trip time
- **Basic host discovery**: Quick check if an IP is in use

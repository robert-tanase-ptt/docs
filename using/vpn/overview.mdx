...
<Note>
The VPN agent needs outbound internet access (TCP port 22 to vpn.pentest-tools.com) to function. It cannot operate in fully air-gapped networks.
</Note>
...
You can share VPN profiles with team members on your account. Shared profiles let team members run scans against your internal networks.
...
For more on team management and sharing, see [Teams and roles](/account/teams-and-roles).

...
<CardGroup cols={2}>
  <Card icon="server" href="/using/vpn/virtual-machine" title="Virtual machine">
    Pre-configured appliance for VMware, Hyper-V, VirtualBox, or ESXi.
  </Card>
  <Card icon="docker" href="/using/vpn/docker-agent" title="Docker agent">
    Containerized agent for Docker environments.
  </Card>
  <Card icon="cloud" href="/using/vpn/cloud" title="Cloud deployment">
    Deploy in AWS or Azure cloud environments.
  </Card>
  <Card icon="shield-halved" href="/using/vpn/openvpn" title="Custom OpenVPN">

...
description: "Deploy the VPN agent as a virtual machine using Hyper-V, VMware, or VirtualBox"
---
...
1. Log in with default credentials (provided in dashboard)
2. Run the configuration wizard
3. Enter your agent token

...
Workspaces are organizational containers that group related assets, targets, scans, findings, and reports. Each workspace provides a separate context for your security testing activities.
...
| Item | Description |
|------|-------------|
| Assets | The targets you add for security testing |
| Targets | Specific scan targets derived from assets |
...
<Tabs>
  <Tab title="By Client">
    **Best for**: Consulting firms and MSPs
    ...
    Create one workspace per client to keep their data separate and generate client-specific reports.
  </Tab>
...
- Share workspaces from **Settings → Team → Sharing**

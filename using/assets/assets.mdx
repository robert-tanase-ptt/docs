...
<Note>
Different tools accept different target types. For example, the Website Vulnerability Scanner requires a URL, while the Port Scanner accepts hostnames or IP addresses.
</Note>

## Importing multiple targets

For bulk operations, you can import targets from a file or cloud provider.
...
<Warning>
Deleting an asset removes all associated targets, scans, and findings permanently. This action cannot be undone.
</Warning>
...
Some tools discover additional targets during scanning:
...
When new targets are discovered, they're automatically associated with the appropriate asset. Discovered subdomains of `example.com` count under the `example.com` asset—you don't consume additional asset slots.

<Tip>
Use the attack surface view to see all targets discovered under each asset.
</Tip>
...
Your subscription includes a maximum number of assets. This limit:

- Applies across all your workspaces
- Is shared among all team members on your account
- Counts unique assets (not targets)

### Checking your usage

View your current asset usage in **My account → Plan details & billing → Scanned assets**.

### When you reach your limit

If you reach your asset limit, you can:

- **Add targets to existing assets** – New URL targets on domains you already have don't consume additional asset slots
- **Delete unused assets** – Remove assets you no longer need to free up capacity
- **Upgrade your plan** – Increase your asset tier for more capacity
...
- [Assets and scan cycles](/plans-and-limits/assets-scan-cycles) – How assets affect your subscription

...
Discovered items appear in the scan results. Results from Website Recon and Port Scanner are also merged into the [attack surface view](/using/attack-surface/attack-surface-overview) automatically. To add discovered subdomains or hosts as targets, add them manually from the scan results.

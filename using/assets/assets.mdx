...
<Info>
AWS import requires a configured AWS integration. See [AWS integration](/integrations/aws) for setup instructions.
</Info>
...
- [AWS integration](/integrations/aws): Import targets from AWS

...
Scheduled scans automate your security testing by running scans at specified intervals, so you don't have to run them manually.
...
When scheduling a scan, you can optionally send the results to [Vanta](/integrations/vanta) for automated compliance monitoring and evidence collection.

**To enable Vanta integration:**
1. First, [configure the Vanta integration](/integrations/vanta) in your account settings
...
Scheduled scans work with the [notifications system](/notifications/overview). Configure alerts to stay informed about your automated scans:

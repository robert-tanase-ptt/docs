...
|------|----------------------|
| [Website Scanner](/tools/website-vulnerability-scanner) | Automatic login form, Recorded, Cookies, Headers |
...
The [Website Scanner](/tools/website-vulnerability-scanner) supports four authentication methods to handle different application types.

### Automatic login form

The scanner automatically fills in and submits a login form. Best for simple forms with username, password, and submit button on a single page.

**Requirements:**
- Login form loads when the page loads (no preceding screens)
- Simple form with only username, password, and submit button

...
The levels are cumulative. Same-domain only allows everything Same-host only allows, plus subdomain changes. Always allows any redirect.
...
- [Authenticated scanning](/using/scans/authenticated-scanning): when authentication is configured, redirect following is disabled automatically

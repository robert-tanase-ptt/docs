...
- Change risk level in batch
- Change verified status in batch
- Send to integrations (Jira, Nucleus)
- Clone findings
- Delete findings (only for manually added or imported findings)

...
<CardGroup cols={2}>
  ...
  <Card title="Webhook" icon="webhook" href="/integrations/webhooks">
    Send to any HTTP endpoint.
  </Card>
  <Card title="Nucleus" icon="layer-group" href="/integrations/nucleus">
...
You can also get notified when scan results **change** from previous scans:

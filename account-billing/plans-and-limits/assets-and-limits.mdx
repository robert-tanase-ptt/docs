...
<Info>
When you reach your concurrent scan limit, additional scans enter the **Waiting** state and run automatically as slots become available. See [Scans and statuses](/core/scans/scans-and-statuses) for details on scan states.
</Info>
